    ...
    render() {
        return (
            <div className="h-20 border-y border-gray-500 flex w-full justify-between">
                <div className="flex">
                    <div className='flex my-5 ml-10 hoverbg text-xl  cursor-pointer '><Accountmodal user={this.props.user}/></div>
                    <div className='flex my-5 ml-10 hoverbg text-xl  cursor-pointer '><Customermodal user={this.props.user}/></div>
                </div>
                <div className="flex">
                    <button onClick={()=>{this.props.setuser(null)}}
