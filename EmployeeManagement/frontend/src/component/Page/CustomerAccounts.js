    ...
    render() {
        if(this.state.data==null){
            ...
            return(<div className="sm:ml-56">
                <div className="fixed w-full bg-white pr-56"><CustomerTopNav accountid={this.props.params.account} authtoken={this.props.user.authToken} setuser={this.props.setuser}/></div>
                <div className="flex flex-wrap pt-20">
                    <div className="lg:w-1/4 md:w-1/2 w-full p-5"><Card><p className="font-sans font-semibold">Account
                        No.</p><p className="font-sans font-semibold text-xl pt-3">{this.props.params.account}</p></Card></div>
                    <div className="lg:w-1/4 md:w-1/2 w-full p-5"><Card><p className="font-sans font-semibold">Account
                        Balance</p><p className="font-sans font-semibold text-xl pt-3">{this.state.data.balance}</p></Card></div>
                    <div className="lg:w-1/4 md:w-1/2 w-full p-5"><Card><p
                        className="font-sans font-semibold">Transactions</p><p
                        className="font-sans font-semibold text-xl pt-3">{this.state.data.transactionsCount}</p></Card></div>
